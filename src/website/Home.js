...
const Home = () => {
    ...
    <>
      ...
      <div id={!checked ? background.mobilemode : background.desktopmode}>
        <img className={background.introicon} src="https://img.icons8.com/external-bearicons-outline-color-bearicons/64/null/external-Space-location-bearicons-outline-color-bearicons.png"/>
