      ...
      <Row>
        <Col id={mercurymenu.aboutMesecond}>
            <Row className={mercurymenu.icon_Row}>
                ...
                <svg className={mercurymenu.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm7.753 18.305c-.261-.586-.789-.991-1.871-1.241-2.293-.529-4.428-.993-3.393-2.945 3.145-5.942.833-9.119-2.489-9.119-3.388 0-5.644 3.299-2.489 9.119 1.066 1.964-1.148 2.427-3.393 2.945-1.084.25-1.608.658-1.867 1.246-1.405-1.723-2.251-3.919-2.251-6.31 0-5.514 4.486-10 10-10s10 4.486 10 10c0 2.389-.845 4.583-2.247 6.305z"/></svg>
                </Col>
        ...
        <Col id={mercurymenu.aboutMesecond}>
            <Row className={mercurymenu.icon_Row}>
                ...
                <svg className={mercurymenu.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 1c-3.148 0-6 2.553-6 5.702 0 3.148 2.602 6.907 6 12.298 3.398-5.391 6-9.15 6-12.298 0-3.149-2.851-5.702-6-5.702zm0 8c-1.105 0-2-.895-2-2s.895-2 2-2 2 .895 2 2-.895 2-2 2zm8 6h-3.135c-.385.641-.798 1.309-1.232 2h3.131l.5 1h-4.264l-.344.544-.289.456h.558l.858 2h-7.488l.858-2h.479l-.289-.456-.343-.544h-2.042l-1.011-1h2.42c-.435-.691-.848-1.359-1.232-2h-3.135l-4 8h24l-4-8zm-12.794 6h-3.97l1.764-3.528 1.516 1.528h1.549l-.859 2zm8.808-2h3.75l1 2h-3.892l-.858-2z"/></svg>
                </Col>
    ...
    <Container style={{marginTop:"0.6090133982947625vh"}}>
      <Row>
        ...
        <Col id={mercurymenu.aboutMesecond}>
            <Row className={mercurymenu.icon_Row}>
                <Col className={mercurymenu.iconLeft}>
                <svg className={mercurymenu.icon} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"><path d="M5 22h-5v-12h5v12zm17.615-8.412c-.857-.115-.578-.734.031-.922.521-.16 1.354-.5 1.354-1.51 0-.672-.5-1.562-2.271-1.49-1.228.05-3.666-.198-4.979-.885.906-3.656.688-8.781-1.688-8.781-1.594 0-1.896 1.807-2.375 3.469-1.221 4.242-3.312 6.017-5.687 6.885v10.878c4.382.701 6.345 2.768 10.505 2.768 3.198 0 4.852-1.735 4.852-2.666 0-.335-.272-.573-.96-.626-.811-.062-.734-.812.031-.953 1.268-.234 1.826-.914 1.826-1.543 0-.529-.396-1.022-1.098-1.181-.837-.189-.664-.757.031-.812 1.133-.09 1.688-.764 1.688-1.41 0-.565-.424-1.109-1.26-1.221z"/></svg>
                </Col>
                <Col className={mercurymenu.iconRight}>
                   취미
                </Col>
    ...
    <Container style={{marginTop:"0.6090133982947625vh"}}>
      <Row>
        ...
        <Col id={mercurymenu.aboutMesecond}>
            <Row className={mercurymenu.icon_Row}>
                <Col className={mercurymenu.iconLeft}>
                <svg className={mercurymenu.icon} clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24"   xmlns="http://www.w3.org/2000/svg"><path d="m12 5.72c-2.624-4.517-10-3.198-10 2.461 0 3.725 4.345 7.727 9.303 12.54.194.189.446.283.697.283s.503-.094.697-.283c4.977-4.831 9.303-8.814 9.303-12.54 0-5.678-7.396-6.944-10-2.461z" fill-rule="nonzero"/></svg>
                </Col>
                <Col className={mercurymenu.iconRight}>
                   특기
                </Col>
        ...
        <Col id={mercurymenu.aboutMesecond}>
            <Row className={mercurymenu.icon_Row}>
                <Col className={mercurymenu.iconLeft_three}>
                <svg className={mercurymenu.icon}  xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M24 21h-3l1-3h1l1 3zm-12.976-4.543l8.976-4.575v6.118c-1.007 2.041-5.607 3-8.5 3-3.175 0-7.389-.994-8.5-3v-6.614l8.024 5.071zm11.976.543h-1v-7.26l-10.923 5.568-11.077-7 12-5.308 11 6.231v7.769z"/></svg>
                </Col>
                <Col className={mercurymenu.iconRight_three}>
                   최종학력
                </Col>
