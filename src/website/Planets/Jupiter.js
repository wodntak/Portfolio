        ...
        <Carousel.Item>
              <Container id={jupitermenu.firstpage}>
                <Row className={jupitermenu.contentsRow}>
                  ...
                  HTML, CSS, Javascript로 처음 제작해본 웹사이트입니다. 다음에 백엔드를 추가 함으로써 PHP로 제작하였습니다. 웹사이트를 제작할 때 페이지 이동 없이 하나의 페이지에
                  모든 정보가 들어갈 수 있도록 스크롤 하여 다음 페이지를 보는 형식으로 제작되었습니다.    
                  </Col>
                </Row>
                <Row className={jupitermenu.contentsRow}>
                <Col xs={12} md={6} lg={3} className={jupitermenu.contenttext}>
                  웹사이트의 footer 부분에는 처음 페이지로 돌아갈 수 있는 버튼과 웹사이트 방문자의 숫자를 표시하였습니다. 방문자 숫자는 데이터베이스에 따로 저장되어 누적 방문자 숫자를 표시합니다.
                  </Col>
            ...
            <Container id={jupitermenu.firstpage}>
                <Row className={jupitermenu.contentsRow}>
                  ...
                  <Col xs={12} md={6} lg={6} className={jupitermenu.contenttext}>
                    로그인과 회원가입 화면입니다. 이름, 이메일, 아이디 형식을 정함으로 방문자들이 형식에 맞게 진행해야 로그인 및 회원가입이 진행되도록 하였습니다. 만약 형식에 맞지 않게 회원가입을 진행하였을 시에는
                    alert 창으로 잘못된 부분을 알려줄 수 있도록 제작하였습니다.
                  </Col>
                </Row>
                <Row className={jupitermenu.contentsRow}>
                <Col xs={12} md={6} lg={3} className={jupitermenu.contenttext}>
                    로그인이 성공했을 때 보게 되는 메뉴바입니다. 사용자의 이름을 표시하고 로그아웃을 누를 시 처음 화면으로 돌아가게 됩니다. My Messages 버튼을 누를 시 사용자가 보냈던 메시지들을
                    한 번에 확인 할 수 있도록 하였습니다.
                  </Col>
                  <Col xs={12} md={6} lg={9} className={jupitermenu.contentimageCol} >
                  <img
            ...
            <Container id={jupitermenu.firstpage}>
                <Row className={jupitermenu.contentsRow}>
                  ...
                  <Col xs={12} md={6} lg={6} className={jupitermenu.contenttext}>
                   로그인이 성공하면 보게 되는 Contact 페이지입니다. 로그인한 사용자는 메시지를 보낼 수 있는 기능이 추가 되어있고 메시지를 보낼 때 입력 양식과 데이터베이스 입력값이 일치하지 않는다면 에러 메시지를 띄우고,
                   메시지가 성공적으로 보내져 데이터베이스에 들어가게 되면 성공했다는 메시지를 띄웁니다. 메뉴바에 "My Messages"를 클릭할 시에 보이는 메시지 페이지는 지금까지 사용자가 보낸 메시지를 한 번에 확인 할 수 있도록 하였습니다.
            ...
            <Carousel.Item>
              <Row className={jupitermenu.contentsRow}>
                ...
                <Col xs={7} md={8} lg={8} className={jupitermenu.contenttext}>
                  이 웹사이트는 처음 제작해본 포트폴리오용 웹사이트입니다. 스크롤 형식의 웹사이트로 페이지 이동 없이 한 페이지에서 모든 정보를 볼 수 있도록 제작되었습니다. 사용자들이 더 재미있게 사이트를 접할 수 있도록 버튼이나 애니메이션들을 
                  넣어서 제작하였습니다. 
                </Col>
              </Row>
              <Row className={jupitermenu.contentsRow}>
